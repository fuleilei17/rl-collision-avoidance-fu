...
def test_goal_point(index):
    ...
    '''
    #door
    goal_list = [[-0.37, 4.12], [-0.33, -3.83], [0.58, -4.55], [0.38, 2.66], [-2.60, -4.48], [2.75, -4.64],
                 [-2.87, 3.99], [2.12, 3.57], [-13.40, -21.11], [-10.64, -22.62], [-7.73, -23.78],
                 [-4.68, -24.56], [-1.57, -24.95], [1.57, -24.95], [4.68, -24.56], [7.73, -23.78], [10.64, -22.62],
                 [13.40, -21.11], [15.94, -19.26], [18.22, -17.11], [20.23, -14.69], [21.91, -12.04], [23.24, -9.20],
                 [24.21, -6.22], [24.80, -3.13], [25.00, 0.00], [24.80, 3.13], [24.21, 6.22], [23.24, 9.20],
                 [21.91, 12.04], [20.23, 14.69], [18.22, 17.11], [15.94, 19.26], [13.40, 21.11], [10.64, 22.62],
    ...
    '''
    #square_person
    goal_list = [[-3.50, -3.50], [3.50, 3.50], [3.50, -3.50], [-3.50, 3.50], [0.00, -3.50], [0.00, 3.50],
                 [-2.87, 3.99], [2.12, 3.57], [-13.40, -21.11], [-10.64, -22.62], [-7.73, -23.78],
                 [-4.68, -24.56], [-1.57, -24.95], [1.57, -24.95], [4.68, -24.56], [7.73, -23.78], [10.64, -22.62],
                 [13.40, -21.11], [15.94, -19.26], [18.22, -17.11], [20.23, -14.69], [21.91, -12.04], [23.24, -9.20],
                 [24.21, -6.22], [24.80, -3.13], [25.00, 0.00], [24.80, 3.13], [24.21, 6.22], [23.24, 9.20],
    ...
    '''
    #shiyan1
    #goal_list = [[-2.50, -2.50], [2.50, 2.50], [2.50, -2.50], [-2.50, 2.50], [0.00, -2.50], [0.00, 2.50]]
      
    #shiyan2
    #goal_list = [[-2.00, 0.00], [2.00, 0.00], [0.00, -2.00], [0.00, 2.00]]    
    
    #shiyan3
    goal_list = [[3, 0], [2.92, 0.67], [2.70, 1.3], [2.34, 1.87], [1.87, 2.34], [1.3, 2.7], [0.67, 2.92], [0, 3]] 
