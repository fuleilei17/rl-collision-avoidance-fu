...
def test_init_pose(index):
    init_pose_list = [[0.00, 5.00, np.pi], [1.15, 4.86, np.pi*26/25], [2.25, 4.46, np.pi*27/25], [3.22, 3.82, np.pi*28/25],
                 [4.02, 2.97, np.pi*29/25], [4.6, 1.95, np.pi*30/25], [4.92, 0.84, np.pi*31/25], [5.00, 0.00, np.pi*32/25],
...
def test_goal_point(index):
    goal_list = [[-0.00, 5.00], [1.15, 4.86], [2.25, 4.46], [3.22, 3.82], [4.02, 2.97], [4.6, 1.95],
                 [4.92, 0.84], [5.00, 0], [-13.40, -21.11], [-10.64, -22.62], [-7.73, -23.78],
