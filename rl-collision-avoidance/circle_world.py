...
class StageWorld():
    def __init__(self, beam_num, index, num_env):
        ...
        #调试
        print("enter the stageworld")

        #调试
        print('the rank_size is: %d'%(index))
    ...
    def generate_goal_point(self):
        ...
        self.pre_distance = 0
        self.distance = copy.deepcopy(self.pre_distance)#深拷贝，拷贝对象及其子对象，对其有改动不影响其第一次的拷贝。
    ...
    def get_reward_and_terminate(self, t):
        ...
        is_crash = self.get_crash_state()#获取碰撞标志
