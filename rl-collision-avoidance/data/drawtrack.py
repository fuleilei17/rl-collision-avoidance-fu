...
data_6 = np.genfromtxt('data_6.txt', delimiter='\t', dtype=float)
data_7 = np.genfromtxt('data_7.txt', delimiter='\t', dtype=float)
...
ax.plot(data_6[:,1], data_6[:,0], label='Robot 6')
ax.plot(data_7[:,1], data_7[:,0], label='Robot 7')
